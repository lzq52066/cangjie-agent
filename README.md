...
>
> 正因为如此，我决定做这样一件事：**为 Java 程序员，造一个真正好用的 AI 框架**——不是简单封装 Python 接口，而是从 Spring Boot、MyBatis-Plus、PostgreSQL 这些熟悉的技术栈出发，构建一个完整的、可扩展的、企业级的智能体平台。**CangJie Agent** 就是这份努力的答案。
